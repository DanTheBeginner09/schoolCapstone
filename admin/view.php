...
<body>
    ...
    <div class="row mb-4">
        <div class="col-md-6"class="personalinfoContainer" >
            <h4 class="personalinfo">Personal Details</h4>
            <div class="personal-details bg-light p-3 rounded">
                <div class="row mb-2">
                    <div class="col"><strong>SY:</strong> <span>2024-2025</span></div>
                    <div class="col"><strong>Remaining Balance:</strong> <span>0</span></div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    <div class="col"><strong>Gender:</strong> <span>Male</span></div>
                    <div class="col"><strong>Age:</strong> <span>21</span></div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    <div class="col"><strong>Status:</strong> <span class="status-button badge bg-success">Active</span></div>
                </div>
                <div class="row mb-2">
                    <div class="col"><strong>1st Quarter:</strong> <span class="quater-button badge bg-success">Cleared</span></div>
                    <div class="col"><strong>2nd Quarter:</strong> <span class="quater-button badge bg-success">Cleared</span></div>
                </div>
                <div class="row mb-2">
                    <div class="col"><strong>3rd Quarter:</strong> <span class="quater-button badge bg-success">Cleared</span></div>
                    <div class="col"><strong>4th Quarter:</strong> <span class="quater-button badge bg-success">Cleared</span></div>
                </div>
            </div>
