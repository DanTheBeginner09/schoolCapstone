...
<div class="main-content">
    ...
    <div class="border">
        <div class="container">
            <div class="tagName">STUDENT INFORMATION</div>
            <div class="content">
                <label for="file-upload">Upload Excel File:</label>
                <input type="file" id="file-upload">
                <p>Excel file should have columns in this order: Student ID, First Name, Last Name, Grade level ..</p>
                <button>
        ...
        <div class="container table-responsive">
            ...
            <div class="row mb-4">
            <form action="studentInfo1.php" method="GET" class="mt-4 d-flex w-100">
    <input name="search" type="search" placeholder="Search By Student ID, Name..." class="form-control me-2" style="padding: 8px; flex: 1;">
